...
/*   Updated: 2024/02/13 12:34:45 by msapin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    displayError(int errorCode, Commands & command) {
	...
	case ERR_NICKNAMEINUSE:
		...
		sendMessage(client.getFD(), ":localhost 433 " + client.getNickname() + " " + *(command.getArgSplit().begin()) + " :Nickname is already in use");
		break;
	case ERR_NOSUCHNICK:

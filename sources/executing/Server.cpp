...
/*   Updated: 2024/01/15 14:25:43 by thmeyer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    while (this->_interrupt == false) {
        ...
        if (this->_fds[0].revents & POLLIN) {
            if (this->_nbClient + 1 < MAXCLIENT) {
                ...
                this->_clientList.insert(std::pair<int, Client *>(this->_nbClient, new Client(this->_nbClient)));
                std::cout << this->_clientList[this->_nbClient]->getID() << std::endl;
